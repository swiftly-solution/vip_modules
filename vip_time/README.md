<p align="center">
  ...
  <h3 align="center">[VIP] Time</h3>

  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/vip-core">Swiftly VIP Core</a> that will give VIP based on hour.
    <br/>
  </p>
</p>
...
2. Change the configuration values from ``/game/csgo/addons/swiftly/configs/plugins/vip-time.json``.
