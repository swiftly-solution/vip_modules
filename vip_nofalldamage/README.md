<p align="center">
  ...
  <h3 align="center">[VIP] No Fall Damage</h3>

  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/vip-core">Swfitly VIP Core</a> that removes the fall damage of a player.
    <br/>
  </p>
</p>
...
2. Add `nofalldamage` to the desired VIP Group in `addons/swiftly/configs/plugins/vips.json`.
### Example:
```json
	"groups": [
		{
