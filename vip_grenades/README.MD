<p align="center">
  ...
  <h3 align="center">[VIP] Grenades</h3>

  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/vip-core">Swiftly VIP Core</a> that gives VIP Players grenades on spawn.
    <br/>
  </p>
</p>
...
2. Add `grenades` to the desired VIP Group in `addons/swiftly/configs/plugins/vips.json`.
### Example:
```json
	"groups": [
		{
