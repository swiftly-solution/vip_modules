<p align="center">
  ...
  <h3 align="center">[VIP] Armor</h3>

  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/vip-core">Swiftly VIP Core</a> that changes the armor value of a VIP Player at spawn.
    <br/>
  </p>
</p>
...
2. Add `armor` to the desired VIP Group in `addons/swiftly/configs/plugins/vips.json`.
### Example:
```json
	"groups": [
		{
			...
			"features": {
				"armor": value // (put , if you need to)
			}
		}
	],
```
