<p align="center">
  ...
  <h3 align="center">[VIP] Money</h3>

  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/vip-core">Swiftly VIP Core</a> that gives a number of money to a VIP Player at spawn.
    <br/>
  </p>
</p>
...
2. Add `money` to the desired VIP Group in `addons/swiftly/configs/plugins/vips.json`.
### Example:
```json
	"groups": [
		{
			...
			"features": {
				"money": value // (put , if you need to)
			}
		}
	],
```
