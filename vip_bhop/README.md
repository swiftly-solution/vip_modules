<p align="center">
  ...
  <h3 align="center">[VIP] Bunnyhop</h3>

  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/vip-core">Swiftly VIP Core</a> that gives bunnyhop to a VIP Player.
    <br/>
  </p>
</p>
...
2. Add `bhop` to the desired VIP Group in `addons/swiftly/configs/plugins/vips.json`.
### Example:
```json
	"groups": [
		{
