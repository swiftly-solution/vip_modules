<p align="center">
  ...
  <h3 align="center">[VIP] Speed</h3>

  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/vip-core">Swiftly VIP Core</a> that gives a number of speed to a VIP Player.
    <br/>
  </p>
</p>
...
2. Add `speed` to the desired VIP Group in `addons/swiftly/configs/plugins/vips.json`.
### Example:
```json
	"groups": [
		{
			...
			"features": {
				"speed": value // (put , if you need to)
			}
		}
	],
```
