<p align="center">
  ...
  <h3 align="center">[VIP] Tracers</h3>

  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/vip-core">Swiftly VIP Core</a> that attaches a tracer to the player's weapon.
    <br/>
  </p>
</p>
...
2. Add `tracercolor` to the desired VIP Group in `addons/swiftly/configs/plugins/vips.json`.
### Example:
```json
	"groups": [
		{
			...
			"features": {
				"tracercolor": value // rgba (example: 0,186,105,255)
			}
		}
	],
```
