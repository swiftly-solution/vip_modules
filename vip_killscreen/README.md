<p align="center">
  ...
  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/vip-core">Swfitly VIP Core</a> that shows the effect from healthshot to VIP Players when they make a kill.
    <br/>
  </p>
</p>
...
2. Add `killscreen` to the desired VIP Group in `addons/swiftly/configs/plugins/vips.json`.
### Example:
```json
	"groups": [
		{
			...
			"features": {
				"killscreen": true // (put , if you need to)
			}
		}
	],
```
